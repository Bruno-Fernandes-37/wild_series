...
class EpisodeController extends AbstractController
{
     ...
     */
    public function new(Request $request,Slugify $slugify, EntityManagerInterface $entityManager, MailerInterface $mailer): Response
    {
        $episode = new Episode();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $email = (new Email())
                ...
                ->subject('Un nouveau episode vient d\'être publiée !')
